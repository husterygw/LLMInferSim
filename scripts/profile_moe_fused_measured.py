...
Unlike report_moe_internal_breakdown.py, this script breaks down measured GPU
kernel time.  It runs the same standalone vLLM fused_experts path used by the
MoE collector, exports a torch.profiler trace, and aggregates CUDA kernels by
