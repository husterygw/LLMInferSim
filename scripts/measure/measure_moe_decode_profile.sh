...
set -e
source /data1/home/ygw268/miniconda3/etc/profile.d/conda.sh
conda activate llm_sim

MODEL="${MODEL:-/data1/home/ygw268/models/Qwen3-30B-A3B-Instruct-2507}"
TP="${TP:-4}"
...
if [ -n "$TRACE" ]; then
    ...
    python "$(dirname "$0")/measure_moe_decode_profile.py" --parse "$TRACE"
else
