...
def test_from_prefill_workload():
    ...
    shape = StepShape.from_workload(wl, "eager")
...
def test_from_decode_workload():
    ...
    shape = StepShape.from_workload(wl, "cudagraph")
...
def test_unknown_phase_raises():
    ...
    with pytest.raises(NotImplementedError):
        StepShape.from_workload(wl, "eager")
...
def test_execution_mode_follows_deploy():
    ...
    wl = _prefill_workload()
    s_eager = StepShape.from_workload(wl, "eager")
    s_graph = StepShape.from_workload(wl, "cudagraph")
