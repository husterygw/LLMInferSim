...
MODEL=${VLLM_INFER_SIM_MODEL:-/data1/home/ygw268/models/Qwen3-4B-Instruct-2507}
...
BASE_OUT=$(VLLM_INFER_SIM_MODEL="$MODEL" python examples/pd_disagg/run_pd_disagg_loopback.py 2>&1 || true)
...
PD_OUT=$(LLM_INFER_SIM_PD_ROLE=kv_both \
         ...
         python examples/pd_disagg/run_pd_disagg_loopback.py 2>&1 || true)
echo "$PD_OUT" | tail -18
